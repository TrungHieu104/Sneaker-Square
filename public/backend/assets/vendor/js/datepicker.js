$( function() {
    // Bound by class, not by the ids #start_coupon / #end_coupon: those two are
    // reused on the promotion and dashboard forms as well, and a third date box
    // on a page would get no picker at all.
