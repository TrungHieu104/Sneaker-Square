            ...
            <div class="authentication-inner" id="aut-login">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Login with Facebook -->
                        <div class="mb-3">
                            <form action="{{route('login_facebook')}}">
                                <button class="btn btn-primary d-flex gap-3 mb-3 justify-content-center py-2 w-100 btn-login_user" style="background-color: #1877F2; border-color: #1877F2;" type="submit">
